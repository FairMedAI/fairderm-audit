...
The addition of synthetic augmentation yielded overall AUROC 0.640 and Dark subgroup AUROC 0.481. The Light--Dark gap widened to $-0.291$. The paired bootstrap comparison gave a Dark AUROC delta of $-0.066$ and $p=0.962$. These findings indicate that simple photometric augmentation from 29 source images did not close the skin-tone performance gap.
...
Bootstrap confidence intervals (1000 iterations) confirmed the high uncertainty. The fine-tuned Dark AUROC bootstrap CI was $[0.341,\; 0.750]$, and the augmented model Dark AUROC CI was $[0.276,\; 0.688]$. Their overlap and the paired comparison p-value of 0.962 show that augmentation did not significantly improve Dark AUROC.
